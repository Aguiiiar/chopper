...
export class Chopper extends Client {
  constructor(options: ChopperOptions) {
  ...
  async registryCommands() {
    ...
    for (const guild of guilds) {
      this.guilds.cache
        .get(guild.id)
        .commands.set(this.commandsArray as ApplicationCommandDataResolvable[]);
    }
